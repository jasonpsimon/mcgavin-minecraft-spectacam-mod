...
public class SpecCamCommand {
     ...
     * Works anywhere a player-name argument is expected.
     *
     * Uses the Iterable&lt;String&gt; overload of {@code CommandSource.suggestMatching}
     * (not the Stream one) since the Iterable form has been present and stable
     * across every yarn version that supports ClientCommandManager v2.
     */
